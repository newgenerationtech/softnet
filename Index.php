...
<body>
  <!-- NAVBAR -->
  <div class="header">    
    <div id="line" style="height:10px; background:#27aae1;"></div>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark nav">
          <div class="container">
            <a href="#" class="navbar-brand"> <marquee>SoftNet.com</marquee></a>
    ...
    <div id="line" style="height:80px;"></div>
    <!-- HEADER -->
    <div class="container">
      <div class="row mt-4">
